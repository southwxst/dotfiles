...
Object.defineProperty(t,"__esModule",{value:!0}),t.Xn=t.Yn=t.to=t.ao=t.zn=t.io=t.co=t.uo=t.D=t.Fn=t.mo=t.do=t.po=void 0
;let s,l,c,u=n.tryParse,m=/<(?!<)(?:.-){0,4}.\w*?(?::i)?>|./g;t.po=m,t.mo=l,t.do=c;let d,p=!0,b=null;t.Fn=b,
t.D=e=>e.length>1?e==="<escape>"?"esc":e.slice(1,-1):e
;let v=e=>e.length>1?`<${e}>`:e,g=(e,o)=>e.length<=o?null:e.includes(" $",o)||e.includes(" =",o)?t.uo(e.slice(o+1),e.includes(" $if=",o)?0:1):e.slice(o+1)
;t.uo=(e,t)=>{let o=a.i(),n=0;for(let a of e.split(" ")){let e=a.indexOf("=");if("$#/=_".includes(a[0])){
...
};t.co=(e,o)=>{let n,i=e.bo;if(o===void 0&&(o=t.to[e.ra]),n=o.length<4?null:a.Sn(o[3]),
typeof i=="string"&&(i=t.uo(i,3)),i){
...
;return e.bo=i,!0};let f=(e,t)=>{
let o=e.mode,n=e.m,r=e.characters,s=e.action,l=e.button,c=r&&typeof r=="string"?a.vo(i.W("c",r)):null,u=typeof o=="string"&&o.endsWith(".queue")
;if(c&&c.length<4)return t.Rn=41,t.Vn=1,t.bo=a.Sn({text:"Too few characters for LinkHints",isError:!0}),t.go=1,!0
;c?e.c=c:"c"in e&&delete e.c,r!=null&&delete e.characters,"action"in e&&delete e.action,"mode"in e&&delete e.mode,
o=s?C[s]:typeof o=="number"?o:typeof o=="string"?C[o.split(".",1)[0]]:null,o=o!=null?o:Math.max(0,n|0),
o>33&&(o=o===65?e.url?64:o:o===40?e.url?e.join!=null?59:42:e.join!=null?57:o:o>79?o-16:o),u&&(o=o<64?o|16:o),
l!=null&&(e.button=typeof l=="string"?l==="right"||l==="auxclick"?2:l.startsWith("mid")||l.startsWith("aux")?1:0:Math.max(0,Math.min(l|0,2))),
...
e.hideHud!=null&&(e.hideHUD||(e.hideHUD=e.hideHud),delete e.hideHud),o!==n&&(e.m=o),o>63&&(t.go=1)};t.io=(e,o,n)=>{
n===void 0&&(n=t.to[e]);let i={Rn:n[0],Vn:n[1],ra:e,bo:o||(n.length<4?null:a.Sn(n[3])),ko:null,go:n[2]}
;return o&&typeof o=="object"&&!t.co(i,n)?null:i},t.zn=e=>{let o=e.bo;return typeof o=="string"&&(t.co(e),o=e.bo),o}
...
}:null),t&&typeof t=="object"?t.sys&&t.sys!==o.Ze.fo||t.browser&&!(t.browser&1)||t.before&&t.before.replace("v","")<o.Ze.To?a:!a:null
...
let n,i,r,u,v,k,f,h,H,x=0,M=new Map,C=new Map,I=null,U=!1,V=null,F=null,N=null,S="color:red";for(d=null,
...
let r=e.split(" ",3),s=r[0],l=r.length>1?r[1]:"",c=r.length>2?r[2]:"",p=s.length+l.length+c.length+2,O=U;switch(s){
case"map":case"map!":case"run":case"run!":let n=s==="run"
;u=void 0,U||(!l||l.length>8&&l.includes("<__proto__>")?$('Unsupported key sequence %c"%s"',S,l||'""',`for "${c||""}"`):s.length===4&&(l.length<2||l.match(m).length!==1||l.slice(-3,-2)===":")?$('"map!" should only be used for a single long key without mode suffix'):M.has(l)&&!T(e,p)?$('Key %c"%s"',S,l,"has been mapped to",M.get(l).ra):c?n||(u=t.to[c])?!(l>="0"&&l<":"||l[0]==="-")||d&&d.has(l[0])?O=!0:$('Invalid key: %c"%s"',S,l,"- a first char can not be '-' or numbers, unless before is `unmap "+l[0]+"`"):$('Command %c"%s"',S,c,"doesn't exist"):$((n?"Lack target when running":"Lack command when mapping")+' %c"%s"',S,l)),
O&&(k=n?t.io("runKey",g(` keys="${c.replace(/"|\\/g,"\\$&")}"`+e.slice(p),0),u):t.io(c,g(e,p),u),k&&(M.set(l,k),
s.length===4&&M.set(y(l),k)));break;case"unmapAll":case"unmapall":M=new Map,C=new Map,I=d=F=N=null,V=0,
...
h=l.length>1&&l.slice(-3,-1)===":o",H=h?N:F,U?i=t.D(l):!c||e.length>p&&!/^(#|\/\/|\$if=\{)/.test(e.slice(p).trimLeft())?$("mapKey: need %s source and target keys:",c?"only":"both",e):l.length>1&&!/^<(?!<[^:]|__proto__>)([acms]-){0,4}.\w*(:[a-z])?>$/.test(l)?$("mapKey: a source key should be a single key with an optional mode id:",e):c.length>1&&!/^<(?!<|__proto__>)([a-z]-){0,4}.\w*>$/.test(c)?$("mapKey: a target key should be a single key:",e):(i=t.D(l),
H&&i in H&&H[i]!==t.D(c)?d&&d.has(i[0])&&i.slice(1)===":n"?w(g(e,p))!==!1&&$("`mapKey %s` and `unmap %s...` can not be used at the same time",l,i[0]):T(e,p)?O=!0:$('The key %c"%s"',S,l,"has been mapped to another key:",H[i].length>1?`<${H[i]}>`:H[i]):O=!0),
O&&w(g(e,p))!==!1&&(H||(H=a.i(),h?N=H:F=H),H[i]=t.D(c),(i.length<2||i.slice(-2,-1)!==":")&&((N||(N=a.i()))[i]=t.D(c)))
;break;case"shortcut":case"command":
U||(c?!(l.startsWith("userCustomized")&&l.length>14)&&o.Ze.wo.indexOf(l)<0?$('Shortcut %c"%s"',S,l,"is not a valid name"):C.has(l)&&!T(e,p-1-c.length)?$('Shortcut %c"%s"',S,l,"has been configured"):O=!0:$("Lack command name and options in shortcut:",e)),
O&&(f=g(e,p-1-c.length),w(f)!==!1&&(i=L(C,l,f),i&&$('Shortcut %c"%s"',S,l,i)));break;case"env":
U||(c?I&&I.has(l)&&!T(e,p-1-c.length)?$('The environment name %c"%s"',S,l,"has been used"):O=!0:$("Lack conditions in env declaration:",e)),
O&&(f=g(e,p-1-c.length),w(f)!==!1&&(I||(I=new Map)).set(l,f));break;case"unmap":case"unmap!":
!l||c&&!"#$".includes(c[0])?$(`unmap: ${c?"only ":""}needs one mapped key:`,e):w(g(e,s.length+l.length+1))===!1||(v=-1,
V!==0&&(v=(V||(V=_.split(" "))).indexOf(l))>=0&&!(v&1)||M.has(l)||l.length>1&&M.has(y(l))?(M.delete(l),
s.length===6&&l.length>1&&M.delete(y(l)),
v<0||V.splice(v,2)):(l.length===1?l>"/"&&l<":"||l[0]==="-":t.D(l)==="esc"||l==="<c-[>")?(i=t.D(l)+":n",
F&&i in F&&F[i]!=="c-v-"+l?$("`unmap %s...` and `mapKey <%s>` can not be used at the same time",l,i):l.length===1&&d&&d.has(l)?s.length!==6&&$('Number prefix: %c"%s"',S,l,"has been unmapped"):(l.length===1&&(d||(d=new Set)).add(l),
F||(F=a.i()),
F[i]="c-v-"+(l.length===1?l:l[1]==="e"?"esc":"["),l.length>1&&(F[i.slice(0,-1)+"i"]=F[i]))):s.length!==6&&$('Unmap: %c"%s"',S,l,"has not been mapped"))
;break;default:$('Unknown mapping command: %c"%s"',S,s,"in",e)}}
for(let e of o.Ze.wo)e.startsWith("user")||C.has(e)||(k=t.io(e,null))&&C.set(e,k);if(V!==0)for(s=M.size,
V||(V=_.split(" ")),r=V.length,x=0;x<r;x+=2)M.has(V[x])||M.set(V[x],t.io(V[x+1],null));o.Ln=M,t.mo=l=C,t.do=c=I,o.yo=F,
o.Ke.m=N},L=(e,o,a)=>{let n,i=1,r=(a=a&&typeof a=="string"?t.uo(a,3):a)&&a.command||(i=0,
o.startsWith("user")?"":o),s=r?1:0;return s&&r in t.to&&(i&&delete a.command,(n=t.io(r,a))&&e.set(o,n),s=2),
s<1?'requires a "command" option':s>1?"":"gets an unknown command"},H=e=>{let t=0;for(let o in e){let a=o.length
...
;t|=a>1||i?r?40:8:o.toUpperCase()!==o&&n.toUpperCase()!==n?16:8}}return t},x=e=>{let n=new Map,i=e!==null,l=b!==null
;i&&(o.Nn=t.Fn=b=null,h(e));let c,u=a.on(o.Ln),v=i&&p;i&&(o.ho=(o.yo?H(o.yo):0)|(u.join().includes(":i>")?64:0))
;for(let e=0;e<u.length;e++){let a=u[e],i=a.match(m),r=i.length-1,l=t.D(i[0]),d=n.get(l)
;if(e>=s&&d!==void 0&&(d===1||r===0||typeof d[i[1]]=="object")){o.Ln.delete(a);continue}if(r===0){d!==void 0&&v&&M(a,d),
n.set(l,1);continue}if(d===1){v&&M(i[0],a);continue}let p=d,b=1;for(d||n.set(l,p={});(c=p[t.D(i[b])])&&c!==1&&b<r;)b++,
p=c;if(c!==1){for(c&&v&&M(a,c);b<r;)p=p[t.D(i[b++])]={};p[t.D(i[r])]=1}else v&&M(i.slice(0,b+1),a)}if(d)for(let e of d){
let t=n.get(e);t&&n.set("c-v-"+e,t)}if(u.length>0){n.set("-",2);for(let e=0;e<=9;e++)n.set(""+e,2)}d=null,
...
enableCSTemp:[42,1,0,{incognito:!0}],enterFindMode:[6,1,1,{active:!0,selected:!0}],enterInsertMode:[3,1,1,{insert:!0}],
enterVisualLineMode:[12,1,1,{mode:"line"}],enterVisualMode:[12,1,1],firstTab:[24,1,0,{absolute:!0}],focusInput:[12,0,0],
...
previousTab:[24,1,0,{$count:-1}],quickNext:[24,1,0],reload:[18,0,1,{r:1}],reloadGivenTab:[32,1,0,{single:!0}],
...
incognito:45,"open-incognito":45,"open-link":46,"open-url":46,"direct-open":46,"open-directly":46,"directly-open":46,
"open-direct":46,"copy-image":36,"edit-url":64,edit:65,"edit-text":65,input:67,"focus-input":67,editable:67,
...
;o.pl.keyMappings=void 0;try{i.Lo("keyMappings",t+e)}catch(e){}o.pl.keyMappings=a}};o.ul&2&&(x(o.z.keyMappings),
o.G||(t.Xn["m-s-c"]=36)),o.pl.keyMappings=e=>{let t=o.yo,n=o.Ke.m,r=o.Nn;x(e)
;let s=JSON.stringify,l=o.yo,c=o.Ke.m,u=!!r&&s(o.Nn)!==s(r);((t?!l||s(t)!==s(l):!!r&&!!l)||u)&&i.bn({N:9,m:o.yo,t:o.ho,
k:u?o.Nn:null,v:a.nextConfUpdate(0)}),(n?!c||s(n)!==s(c):c)&&i.De({m:c})}});