...
value:!0}),t.He=t.ce=t.ve=t.ue=void 0,t.ue={Uo:(e,t)=>"vimiumContent|"+e+(t?"|"+t:""),Wo(e,t){let o=r.t.contentSettings
...
u:n.Ze.Qe+"#optionalPermissions"})},800),!0)},Jo(e,t){if(e.startsWith("file:")){let t=1
...
;let n,r=e.match(/^([^:]+:\/\/)([^\/]+)/),i=o.xi.exec(r[2]),a=i[3]+(i[4]||"");if(n=[(e=r[1])+a+"/*"],
...
d===u.length-f&&e==="http://"&&n.push("https://*."+a+"/*"),n},Qo(e){let t;for(let{s:{Jl:n}}of e.J){let e=new URL(n).host
;if(t&&t!==e)return!0;t=e}return!1},Ko(e,n){let l=r.t.contentSettings[e];n==null?(l.clear({scope:"regular"}),l.clear({
scope:"incognito_session_only"},r.g),a.lu(t.ue.Uo(e),null)):l.clear({scope:n?"incognito_session_only":"regular"})},
ae(e,l){let r=e.type?""+e.type:"images";return!t.ue.Wo(r,"http://a.cc/")&&(t.ue.Ko(r,l?l.s.se:n.de===2),
s.showHUDEx(l,"csCleared",0,[[r[0].toUpperCase()+r.slice(1)]]),!0)},Se(e,n,l,r){let o=e.type?""+e.type:"images",i=l[0]
;e.incognito?t.ue.Zo(n,o,i,r):t.ue.Eo(o,n,i,e.action==="reopen",r)},Eo(e,l,i,s,u){let c=o.mi(i.url)
;t.ue.Wo(e,c)?u(0):r.t.contentSettings[e].get({primaryUrl:c,incognito:i.incognito},o=>{t.ue.Xo(e,c,l,{
...
let o,c=!r.Ie()||(o=n.a.get(i.id))&&o.J.length>1&&t.ue.Qo(o)
...
r.g()))})})},Zo(e,l,i,a){if(n.Ze.ls)return s.complainLimits(c.A("setIncogCS")),void a(0);let u=o.mi(i.url)
;t.ue.Wo(l,u)?a(0):r.t.contentSettings[l].get({primaryUrl:u,incognito:!0},n=>r.g()?(r.t.contentSettings[l].get({
primaryUrl:u},n=>{n&&n.setting==="allow"?a(1):r.Be.create({type:"normal",incognito:!0,focused:!1,url:"about:blank"},n=>{
let o=n.tabs[0].id;return t.ue.Yo(e,l,i,u,n.id,!0,()=>{r.Me.remove(o)})})
}),r.g()):n&&n.setting==="allow"&&i.incognito?t.ue.Wi(i):void r.Be.getAll(r=>{
...
;let o=d.preferLastWnd(r);if(n&&n.setting==="allow")return t.ue.Wi(i,o.id)
;let a=i.windowId,s=i.incognito&&r.some(e=>e.id===a);return t.ue.Yo(e,l,i,u,s?void 0:o.id)}))},Yo(e,n,l,o,i,a,s){
let u=t.ue.Qi.bind(null,l,i,s);return t.ue.Xo(n,o,e,{scope:"incognito_session_only",setting:"allow"
},a&&i!==l.windowId?e=>{if(e)return u(e);r.Be.get(l.windowId,u)}:u)},Xo(e,n,o,i,a){
let s,u=!1,c=r.t.contentSettings[e],f=()=>{let e=r.g();return e&&console.log("[%o]",Date.now(),e),u||(--s,u=!!e,
(u||s===0)&&setTimeout(a,0,u)),e},d=t.ue.Jo(n,o|0);if(s=d.length,s<=0)return a(!0);l.Sn(i)
;for(let e of d)c.set(Object.assign({primaryPattern:e},i),f)},Qi(e,n,l,o){o!==!0&&t.ue.Wi(e,n),l&&l(),
o!==!0?n&&r.Be.update(n,{focused:!0,state:o?o.state:void 0}):f.runNextCmd(0)},Wi(e,t){e.active=!0,
typeof t=="number"&&e.windowId!==t&&(e.index=void 0,e.windowId=t),_.Pe(e)}},t.ve={Lo({l:e,n:l,s:r,u:o},i,s){
if(e&&r[0]===0&&r[1]===0)if(r.length===2){let e=o.indexOf("#");e>0&&e<o.length-1&&(r=[0,0,o.slice(e)])
}else(r[2]||"").length<2&&(r=[0,0]);s=s>=0?s:-1
;let u=i?r:r.length!==2||r[0]||r[1]?r.length!==2||r[1]>524287||r[0]>8191?r:Math.max(0,r[0])|Math.max(0,r[1])<<13:0,c=t.ve.Bi(l,e?o:""),f=e?u:u?{
s:u,t:s,u:o.slice(0,8192)}:{t:s,u:o.slice(0,8192)};i?(n.Co||(y.Vi(),n.Co=new Map)).set(c,f):a.lu(c,f)},Oi(e,o,i,u){
let{n:c}=o,_=t.ve.Bi(c,o.l?o.u:""),m=i.s.se&&(n.Co===null||n.Co===void 0?void 0:n.Co.get(_))||a.jo(_),p=typeof m=="number"?[m&8191,m>>>13]:typeof m=="string"?JSON.parse(m):m?m instanceof Array?m.slice(0):{
url:m.u,tabId:m.t,scroll:typeof m.s!="number"?m.s||[0,0]:[m.s&8191,m.s>>>13]}:m;if(typeof m=="string"&&t.ve.Lo({l:o.l,
...
Bi:(e,t)=>t?"vimiumMark|"+i.zi(t.slice(0,499).split("#",1)[0])+(t.length>1?"|"+e:""):"vimiumGlobalMark|"+e,
...
n.Ji(l,19,e,1,1)):f.portSendFgCmd(l,19,!0,e,1)})}else r.p(e,0,null,(e,t)=>{window.scrollTo(e,t)
},[a[0],a[1]],u?()=>(f.runNextCmdBy(1,u),r.g()):null)},Mi(e,l,r,o){let i=n.a.get(l),a=e.w;s.ai(i).then(()=>{
t.ve.Xi(l,i,null,!1,e.n,e.s,o||a===!1?0:typeof a!="number"?200:a,e.f,r)}),e.t!==l&&e.n&&t.ve.Lo({l:!1,n:e.n,s:e.s,u:e.u
},n.de===2,l)},pe(e){let l=t.ve.Bi("",e),r=0;n.su.forEach((e,t)=>{t.startsWith(l)&&(r++,a.lu(t,null))});let o=n.Co
...
;i.sa&&i.sa();let s=e?n.Po||(y.Vi(),n.Po=i.ia.slice(0)):i.ia;if(!r)return(s[s.length-(o||1)]||"").replace(/\r/g,"\n")
...
a.lu("findModeRawQueryList",""))}};let y={ca:!1,Zt:0,Vi(){y.ca||(r.Be.onRemoved.addListener(y.fa),y.ca=!0)},fa(){
...
;e.length&&r.t.contentSettings&&setTimeout(()=>{for(let n of e)t.ue.Ko(n)},100)}),n.pl.vomnibarOptions=e=>{
