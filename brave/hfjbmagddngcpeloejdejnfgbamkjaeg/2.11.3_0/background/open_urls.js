...
;if(n.length===0)return;return v(n),void(s&&s.length>0?M(s):t.getCurTab(M))}setTimeout(()=>{
let l=n.a.get(m),e=l?l.d:null,t=i.Sn({keys:[p[1]]});n.ki=null,p[0]==="run1"?n.I(p[1],e,{c:u.$f,r:u.$retry,u:0,w:0
}):a.executeCommand(f.io("runKey",t),1,0,e,0,null)},0)}},y=(l,e,n)=>{l?a.runNextOnTabLoaded(e,n):a.runNextCmdBy(0,e)
...
;l=t?r._r(l,e,u):r.K(l.trim().split(i.q),e,o?-2:u),l=t||!o?l:r._r(l,null,r.ci&&l.startsWith("vimium:")?3:u)}
let w=n.$.goNext;w&&l&&typeof l=="string"&&(l=n.S(l,8192,null,{}),l=e.goToNextUrl(l,n.x,w==="absolute")[1],
v.F&&(l=r.K(l.trim().split(i.q),v.F,3))),l=typeof l=="string"?r.si(l):l}else l=n.newTabUrl_f
;let v=n.$,m=e.parseReuse(v.reuse),c=m===0||m===3?w(v.incognito):null;n.$=null,i.Gl(),c!=null&&c!==(n.de===2)&&(m=-1),
typeof l!="string"?Promise.resolve(l).then(b.bind(0,u,v,s)):!e.openShowPage(l,m,v)&&(i.Ei(l)?e.openJSUrl(l,v,null,m):e.yi(l)?a.runNextCmdBy(0,v):m===1||m===-3?T(l,m,v.replace,null,{
...
;v=g?u.Ti(v,k):v,v=n.S(v,o,b,t);let s=(d=t.F)!==null&&d!==void 0?d:c,a=v.trim();r.pi(),
k&&!s?v=v!==e?r._r(a,null,-1):a:g||!f&&!s?(a=g?u.Pi(a,g):a,v=r._r(a,s,f?-1:3)):(v=r.K(a.split(i.q),s,s&&s!=="~"?-1:0),
v=r.ci?r._r(a=v,s="",v.startsWith("vimium:")?3:0):v),
r.dr===4&&!s&&n.z.preferBrowserSearch&&(v=`vimium://b-search-at/${$}/${a}`,v=r._r(v,null,2)),
r.dr!==2&&r.dr!==1||l.h==null?r.dr===3&&v.startsWith("vimium:")&&!e.startsWith("vimium://")&&(v=r._r(v,null,r.ci||v.startsWith("vimium://run")?3:0)):v=(l.h?"https":"http")+v.slice(v[4]==="s"?5:4),
...
;a.runNextOnTabLoaded(l.f||{},e,l.s&&(()=>{v.ve.Mi(l,e.id,0,p)}))},p=!1,m=r.si(l.u.split("#",1)[0]);if(e.yi(m,u))return
