...
let e=t.O.s,l=t.x<0?-t.x:t.x,n=t.$.index,r=n?n==="other"?l+1:n==="count"?l:n>=0?-1-(0|n):0:0,o=t.$.highlight,u=t.$.extend,a=u==="before"||t.$.direction==="before"?-1:1,s=!!r||!t.$.active,d=null
;e.b&32||(e.b|=32,d=i.k(e)),f.sendFgCmd(1,!0,f.wrapFallbackOptions({c:r>0?t.x/l:t.x,l:s?1:0,f:d,d:a,
m:typeof o=="number"?o>=1?Math.min(o|0,200):0:o?s?100:20:0,n:!!t.$.normalize,r:t.$.returnToViewport===!0,
s:!r&&l<2&&!!t.$.selected,t:u?a>0?2:1:0,p:!!t.$.postOnEsc,e:!!t.$.restart,u:!!t.$.scroll&&t.$.scroll!=="auto",
q:t.$.query?t.$.query+"":s||t.$.last?c.ce.ln(e.se,"",r<0?-r:r):""}))},l.initHelp=(e,l)=>f.initHelpDialog().then(n=>{
...
o:t.Ze.Qe,f:e.f,e:!!a.exitOnClick,c:u&&!!s.Fn||t.z.showAdvancedCommands})}),l.showVomnibar=e=>{var i;let r=t.O,u=t.$.url
;if(u!=null&&u!==!0&&typeof u!="string"&&(u=null,delete t.$.url),!r){
if(r=((i=o.C())===null||i===void 0?void 0:i.R)||null,!r)return;t.O=r}let a=null;if(u!=null&&t.$.urlSedKeys){
let n=typeof u=="string"?u:typeof t.$.u=="string"?t.$.u:o.j();if(n&&n instanceof Promise)return void n.then(t=>{
f.overrideCmdOptions({u:t||""},!0),l.showVomnibar(e)});let i={};a=t.S(n,0,{r:null,k:t.$.urlSedKeys},i),
i.F!=null&&f.overrideCmdOptions({keyword:i.F})}t.$.mode==="bookmark"&&f.overrideOption("mode","bookm")
;let s=t.vomnibarPage_f,{Jl:d}=r.s,c=!s.startsWith(t.Ze.U),m=d.startsWith(t.Ze.U),p=e||!s.startsWith(t.ll)?t.Ze.Jn:s,g=(e=e||(c?m||s.startsWith("file:")&&!d.startsWith("file:///")||s.startsWith("http:")&&!/^http:/.test(d)&&!/^http:\/\/localhost[:/]/i.test(s):r.s.se||m&&!s.startsWith(d.slice(0,d.indexOf("/",d.indexOf("://")+3)+1))))||s===p||r.s.m<0,v=t.$.trailingSlash,b=t.$.trailing_slash,h=f.copyCmdOptions(n.Sn({
v:g?p:s,i:g?null:p,t:g?0:c?2:1,s:v!=null?!!v:b!=null?!!b:null,j:g?"":t.Ze.Un,e:!!t.$.exitOnClick,u:a,
url:typeof u=="string"&&a||u,k:n.Kn(!0),h:t.Wn.Qn}),t.$);h.icase==null&&t.Wn.actions.includes("icase")&&(h.icase=!0),
f.portSendFgCmd(r,6,!0,h,t.x),h.k="omni",t.$=h},l.me=(e,l,n)=>{let i=e.s.m,r=i>=0?i:t.he,u=e.s.Q||i<0?t.a.get(r):null
...
l.framesGoBack=(e,t,n)=>{let r=f.hasFallbackOptions(e.o)?(f.replaceCmdOptions(e.o),
f.getRunNextCmdBy(0)):i.g,o=n?n.id:t.s.m,u=e.s,a=d.parseReuse(e.o.reuse||0);if(a){let t=e.o.position
;i.Me.duplicate(o,n=>{if(!n)return r();a===-2&&i.selectTab(o);{let t=f.parseFallbackOptions(e.o)||{};t.reuse=0,
l.framesGoBack({s:u,o:t},null,n)}let s=n.index--,c=t==="end"?-1:d.newTabIndex(n,t,!1,!0)
;c!=null&&c!==s&&i.Me.move(n.id,{index:c===3e4?-1:c},i.g)})}else{let e=u>0?i.Me.goForward:i.Me.goBack
;for(let l=0,t=u>0?u:-u;l<t;l++)e(o,l?i.g:r)}},l.mainFrame=()=>{let e=o.C(),n=e&&e.R
...
;setTimeout(()=>{o.ai(t.a.get(t.he),!0).then(()=>{let e=t.a.get(t.he);if(!e||e.b&512)r&&f.runNextCmdBy(1,r);else{
