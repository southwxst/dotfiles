...
}),o.qo=o.B=o.Ni=o.E=o.W=o.xo=o.De=o.bn=o.gl=o.jo=o.lu=o.Lo=o.vl=o._o=o.So=o.$o=void 0;let c=null,r=null;o.$o=0,
o.So=null,o._o=a.t.storage.local,o.vl=Promise.all([0,a.je(a.t.runtime.getPlatformInfo).then(e=>{
let o=e.os.toLowerCase(),s=a.t.runtime.PlatformOs,n=o===s.WIN?2:o===s.MAC?0:1;t.Ze.fo=o,t.Ke.o=t.V.o=n,t.G=n
...
;return t.V.g=t.z.grabBackFocus,t.Ke.l=t.V.l,t.ul=t.ul|2,e[2]}),o.vl.then(()=>{t.os&&t.os()}),o.Lo=(e,a)=>{t.z[e]=a,
r||(r=s.i(),setTimeout(h,0));let n,l=a!==o.E[e]?a:null;if(r[e]=l,t.Fo(e,l),e in o.B&&o.W(o.B[e],a,t.V),
...
;for(let s=0,a=e?3:0;s<a;s++)o.lu(o.qo[s],null),t.Fo(o.qo[s],null)}},newTabUrl(e){
...
;if(e)((s=a.get("~"))===null||s===void 0?void 0:s.Hi)||l.ru("~:"+e,a);else if(a.clear(),a.set("~",{Ir:"~",
Jl:t.z.searchUrl.split(" ",1)[0],u:"",Hi:!1}),t.Hl.rules=[],t.newTabUrl_f=t.su.get("newTabUrl_f")||"",
...
e=(e=n.si(e)).replace(":version",`${parseFloat(t.Ze.To)}`)),
...
i.wo=Object.keys(e.commands||{}).map(e=>e==="quickNext"?"nextTab":e),i.To=e.version,i.aa=e.version_name||e.version,
