...
},O=(e,t)=>{d=e,e==="keyLayout"&&(t=t&-33|l.z[e]&32),i.Lo(e,t),d="",e in i.B&&i.bn({N:6,d:[i.B[e]]})},j=(e,t)=>{
...
!e||l.Fo!==j)return;let p=Object.keys(e).length>0?new TextEncoder:null;for(let t in e){
...
;l.pl.vimSync=e=>{if(!b())return;let t=b().onChanged,n=g;if(!e)return t.removeListener(n),void(l.Fo=l.u)
;l.Fo!==j?(t.addListener(n),l.Fo=j):a&&(m(f,"save immediately"),J())},i.vl.then(()=>{let e=l.z.vimSync
;e===!1||!e&&!l.zo?l.il=null:l.il?(p=l.il.then(e=>(l.il=null,!!e&&e.reason==="install")).then(e=>new Promise(t=>{
b()?b().get(n=>{let u=r.g(),o=e&&l.zo&&(u||Object.keys(n).length===0)?()=>{i.Lo("keyLayout",2),t()}:t
...
l.z.vimSync&&l.Fo!==j&&i.gl("vimSync")})):i.gl("vimSync")})});